                      ...
                      return (
                        ...
                        >
                          <input
                            ...
                            onBlur={onBlur}
                          />
                          <div className="relative flex size-12 cursor-pointer items-center justify-center overflow-hidden rounded-full border border-input font-semibold transition peer-checked:bg-background peer-checked:text-primary peer-disabled:cursor-not-allowed peer-disabled:opacity-50 peer-checked:[&>*]:block">
                            {index + 1}
                            <span className="absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 text-4xl text-primary opacity-30">
                              ✗
                            </span>
                          </div>
                        </label>
        ...
        <CardFooter className="flex flex-col items-stretch gap-2">
          <div className="flex items-center justify-between gap-2">
            <Button
              type="button"
              onClick={() =>
                setNumbers(getRandomPicks(pickLength, maxBallValue))
              }
            >
